    ...
    >
      <div className=" container mx-auto">
        <div className="flex items-center justify-between">
          ...
          {/* Button */}
          <button className="btn flex items-center justify-center gap-x-[20px] group hover:text-white shadow-lg px-8 bg-white text-base font-bold text-primary  hover:bg-accent-primary">
            Request Demo{" "}
